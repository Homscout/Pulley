...
private let kPulleyDefaultCollapsedHeight: CGFloat = 75.0
private let kPulleyDefaultPartialRevealHeight: CGFloat = 151.0
...
open class PulleyViewController: UIViewController, PulleyDrawerViewControllerDelegate {
    ...
    override open func viewDidLayoutSubviews() {
        ...
        if displayModeForCurrentLayout == .bottomDrawer
        {
            ...
            drawerContentContainer.frame = CGRect(x: 0, y: drawerScrollView.bounds.height - lowestStop, width: drawerScrollView.bounds.width, height: drawerScrollView.bounds.height)
